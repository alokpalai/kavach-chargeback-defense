...
[![ci](https://github.com/alokpalai/kavach-chargeback-defense/actions/workflows/ci.yml/badge.svg)](https://github.com/alokpalai/kavach-chargeback-defense/actions/workflows/ci.yml)
[![live demo](https://img.shields.io/badge/demo-live-FF4B4B?logo=streamlit&logoColor=white)](https://kavach-chargeback-defense.streamlit.app/)
...
**▶ [Try it live](https://kavach-chargeback-defense.streamlit.app/)** — every cost assumption is a slider. Change the dispute fee, the churn cost, the 3DS pass rate, and watch whether the conclusion survives. It does.
