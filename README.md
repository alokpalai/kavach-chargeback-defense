...
> **₹3,277,951 saved per 10,000 orders** on a held-out test set, against a merchant who approves everything — and **1.9× what the same model earns** under a conventional block/allow policy.
...
| Three-way, uncapped `0.0146 / 0.4360` | ₹2,066,945 | ₹3,369,380 |
| **Three-way, step-up ≤ 10% `0.0232 / 0.4360`** | **₹2,158,374** | **₹3,277,951** |
